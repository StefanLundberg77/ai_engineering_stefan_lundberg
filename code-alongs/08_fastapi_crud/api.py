...
from data_processing import library_data, save_library, query_duckdb
from models import Book, Prompt
...
async def create_book(query: Prompt):
    ...
    query_duckdb(
        ...
        parameters=[book.title, book.year, book.author, movie.rating],
    )
